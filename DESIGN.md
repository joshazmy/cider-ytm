...
- **Immersive (mode):** split studio stays for lyrics-first. Art column must show title/artist/like, not a mute poster. Do not cover the rail unless the user asked for immersive.
